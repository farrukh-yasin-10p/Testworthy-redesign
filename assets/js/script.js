...
function edit_statusList(a){
  console.log('working')
  var list2 = document.getElementById('list_search_edit5');
  list2.style.display = a ;
}

function edit_assignList(a){
  var list2 = document.getElementById('list_search_edit6');
  list2.style.display = a ;
}

function add_statusList(a){
  console.log('working')
  var list2 = document.getElementById('list_search_edit3');
  list2.style.display = a ;
}

function add_assignList(a){
  var list2 = document.getElementById('list_search_edit4');
  list2.style.display = a ;
}
...
// $('.test-suites-section .date-picker .drp-buttons .applybtn').click(function(){
//   console.log('hello')
//   $('.test-suites-section .date-status').css('display', 'block');
// })